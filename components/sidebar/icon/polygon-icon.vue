...
<template>
  ...
  >
    <path
      d="M18 38C18 40.2091 16.2091 42 14 42C11.7909 42 10 40.2091 10 38C10 35.7909 11.7909 34 14 34C16.2091 34 18 35.7909 18 38Z"
      :fill="isOpen ? '#8ED1FE' : '#F7F7F7'"
    />
    <path
      fill-rule="evenodd"
      clip-rule="evenodd"
    ...
    />
    <path
      d="M14 20C14 22.2091 12.2091 24 10 24C7.79086 24 6 22.2091 6 20C6 17.7909 7.79086 16 10 16C12.2091 16 14 17.7909 14 20Z"
      :fill="isOpen ? '#8ED1FE' : '#F7F7F7'"
    />
    <path
      fill-rule="evenodd"
    ...
    />
    <path
      d="M42 20C42 22.2091 40.2091 24 38 24C35.7909 24 34 22.2091 34 20C34 17.7909 35.7909 16 38 16C40.2091 16 42 17.7909 42 20Z"
      :fill="isOpen ? '#8ED1FE' : '#F7F7F7'"
    />
    <path
      fill-rule="evenodd"
    ...
    />
    <path
      d="M38 38C38 40.2091 36.2091 42 34 42C31.7909 42 30 40.2091 30 38C30 35.7909 31.7909 34 34 34C36.2091 34 38 35.7909 38 38Z"
      :fill="isOpen ? '#8ED1FE' : '#F7F7F7'"
    />
    <path
      fill-rule="evenodd"
    ...
    />
    <path
      d="M28 10C28 12.2091 26.2091 14 24 14C21.7909 14 20 12.2091 20 10C20 7.79086 21.7909 6 24 6C26.2091 6 28 7.79086 28 10Z"
      :fill="isOpen ? '#8ED1FE' : '#F7F7F7'"
    />
    <path
      fill-rule="evenodd"
